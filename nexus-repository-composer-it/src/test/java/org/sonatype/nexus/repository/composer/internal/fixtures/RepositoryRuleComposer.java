...
public class RepositoryRuleComposer
    extends RepositoryRule
    implements ComposerRepoRecipes
{
  public RepositoryRuleComposer(final Provider<RepositoryManager> repositoryManagerProvider) {
